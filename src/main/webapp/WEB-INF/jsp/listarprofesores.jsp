        	...
        	<div class="inputBox">
											...
											<div class="form-group multiple-form-group" data-max=3>
												...
												<div class="form-group input-group">
													<form:input path="telefonos[0].numero" type="text" name="telefonos[]" class="inputplus" pattern="^[9|8|7|6]\d{8}$" maxlength="9" title="Tel�fono con formato inv�lido. 9 d�gitos comenzando con 9,8,7 � 6"/>
											...
											<div class="form-group multiple-form-group" data-max=3>
												<div class="inputBox">
													...
													<div class="form-group input-group">
													<form:input path="emails[0].email" type="email" name="emails[]" class="inputplus" title="El email introducido no es v�lido"/>
													<span class="input-group-btn">
